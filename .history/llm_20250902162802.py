...
def get_ai_response(user_message):
    ...
    print(first_chains.invoke({"question": user_message}))


    full_chain = {"topic": RunnableLambda(first_chain), "question": lambda x: x["question"]} | RunnableLambda(
        route
    )
    print(full_chain.invoke({"question": user_message}))
